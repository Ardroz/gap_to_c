...
void B_MUX_S_N_FUNCTION(int SEL_1, int IN_1, int DFLT_1, int IN_2, int DFLT_2, int IN_3, int DFLT_3, int IN_4, int DFLT_4, int IN_5, int DFLT_5, int IN_6, 
					   int DFLT_6, int IN_7, int DFLT_7, int IN_8, int DFLT_8, int IN_9, int DFLT_9, int IN_10, int DFLT_10, int IN_11, int DFLT_11, 
					   int IN_12, int DFLT_12, int IN_13, int DFLT_13, int IN_14, int DFLT_14, int IN_15, int DFLT_15, int IN_16, int DFLT_16, int IN_17, 
					   int DFLT_17, int IN_18, int DFLT_18, int IN_19, int DFLT_19, int IN_20, int DFLT_20, int IN_21, int DFLT_21, int IN_22, int DFLT_22, int IN_23, int DFLT_23, 
					   int *OUT_1, int *OUT_2, int *OUT_3, int *OUT_4, int *OUT_5, int *OUT_6, int *OUT_7, int *OUT_8, int *OUT_9, int *OUT_10, int *OUT_11, 
					   int *OUT_12, int *OUT_13, int *OUT_14, int *OUT_15, int *OUT_16, int *OUT_17, int *OUT_18, int *OUT_19, int *OUT_20, int *OUT_21,
