...
SFC_STEP_PRGFAILSFC_SFC_STEP = SFC_STEP_FUNCTION( 0 , 0 , SFC_STEP_VENT_TRAN_2 , SHUTDOWN_SDN_LATCH1 );
...
SFC_STEP_STITOESN_SFC_STEP = SFC_STEP_FUNCTION( 0 , 0 , SFC_STEP_STI_3_TRAN_2 , SFC_STEP_MOTOR_1_TRAN_2 , SFC_STEP_MOTOR_2_TRAN_2 , SFC_STEP_MOTOR_3_TRAN_2 , SFC_STEP_MOTOR_4_TRAN_2 , SFC_STEP_MOTOR_5_TRAN_2 , SFC_STEP_MOTOR_6_TRAN_2 , SHUTDOWN_SDN_CORE_B_NAME );
SFC_STEP_STI_1_SFC_STEP = SFC_STEP_FUNCTION( 0 , 0 , SFC_STEP_ACCTOSYNC_TRAN_3 , SFC_STEP_WARMUP_TRAN_3 , SFC_STEP_WATER_INJ_TRAN_3 , FALSE , SFC_STEP_UNITONLINE_TRAN_3 , SFC_STEP_NORM_1_TRAN_3 , SFC_STEP_NORM_2_TRAN_3 , SFC_STEP_NORM_3_TRAN_3 , SFC_STEP_NORM_4_TRAN_3 , SFC_STEP_NORM_5_TRAN_3 , SFC_STEP_FSNL_TRAN_3 , SFC_STEP_READY2SYNC_TRAN_3 , SHUTDOWN_SDN_CORE_B_NAME , SHUTDOWN_SD_CORE_B_NAME , SFC_STEP_STP_DN_OR );
SFC_STEP_STI_2_SFC_STEP = SFC_STEP_FUNCTION( 0 , 0 , SFC_STEP_STI_1_TRAN_3 , SHUTDOWN_SDN_CORE_B_NAME , SHUTDOWN_SD_CORE_B_NAME , SFC_STEP_STI_RESET_AND , SFC_STEP_SI_DN_Z_ZMINUS1_B );
SFC_STEP_STI_3_SFC_STEP = SFC_STEP_FUNCTION( 0 , 0 , SFC_STEP_STI_2_TRAN_4 , SHUTDOWN_SDN_CORE_B_NAME , SHUTDOWN_SISDESN_LATCH1 , SHUTDOWN_CHOP_FUEL_B_NAME );
