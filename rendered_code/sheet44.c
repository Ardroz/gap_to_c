...
COND_MON_ABC2ABDCNT_CMP_OUT = CMP_OUT_FUNCTION( 0 , COND_MON_ABCABDNENA_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_15_OUT_1 , 0_0 );
...
COND_MON_ABCPLTCNT_CMP_OUT = CMP_OUT_FUNCTION( 0 , COND_MON_ABCPLTENA_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_14_OUT_1 , 0_0 );
...
COND_MON_ABPLTCNT_CMP_OUT = CMP_OUT_FUNCTION( 0 , COND_MON_ABPLTENA_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_13_OUT_1 , 0_0 );
...
COND_MON_CDCNT_CMP_OUT = CMP_OUT_FUNCTION( 0 , COND_MON_CD_ENABLE_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_CD_OUT_1 , 0_0 );
...
COND_MON_NSCNT_CMP_OUT = CMP_OUT_FUNCTION( 0 , COND_MON_NS_ENABLE_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_NS_OUT_1 , 0_0 );
...
COND_MON_STGCNT_CMP_OUT = CMP_OUT_FUNCTION( 0 , COND_MON_STGRENA_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_09_OUT_1 , 0_0 );
