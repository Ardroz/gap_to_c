...
BENTLY_N25MXVSN25_I_COMPARE = I_COMPARE_FUNCTION( BENTLY_N25_TO_I_OUT_1 , BENTLY_N25_TO_I_OUT_2 );
BENTLY_N25_TO_I_A_TO_INT = A_TO_INT_FUNCTION( 0 , CORE_ANALOG_N25SEL , CORE_ANALOG_T_N25MAX );
