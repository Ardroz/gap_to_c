...
MAPPING_NEG_CHK_10_I_COMPARE = I_COMPARE_FUNCTION( MAPPING_NEGIN_10_OUT_1 , 0 );
MAPPING_NEG_CHK_11_I_COMPARE = I_COMPARE_FUNCTION( MAPPING_NEGIN_11_OUT_1 , 0 );
MAPPING_NEG_CHK_6_I_COMPARE = I_COMPARE_FUNCTION( MAPPING_NEGIN_6_OUT_1 , 0 );
MAPPING_NEG_CHK_7_I_COMPARE = I_COMPARE_FUNCTION( MAPPING_NEGIN_7_OUT_1 , 0 );
MAPPING_NEG_CHK_8_I_COMPARE = I_COMPARE_FUNCTION( MAPPING_NEGIN_8_OUT_1 , 0 );
MAPPING_NEG_CHK_9_I_COMPARE = I_COMPARE_FUNCTION( MAPPING_NEGIN_9_OUT_1 , 0 );
MAPPING_NEQSW_6_I_SW = I_SW_FUNCTION( MAPPING_NEG_CHK_6_LT , MAPPING_NEGIN_6_OUT_1 , MAPPING_ADDNEG_6_I_ADD );
MAPPING_SMALLNEGS2_I_TO_AN = I_TO_AN_FUNCTION( 0 , MAPPING_NEQSW_6_I_SW , MAPPING_NEGSW_7_I_SW , MAPPING_NEGSW_8_I_SW , MAPPING_NEGSW_9_I_SW , MAPPING_NEGSW_10_I_SW , MAPPING_NEGSW_11_I_SW );
