...
SFC_STEP_HOLD_OFF_ACTIVETIME = ACTIVETIME_FUNCTION( 0 , 0 , SFC_STEP_WWCRANK_11_TRAN_2 , SFC_STEP_NOT_ABORT_NOT );
SFC_STEP_HOLD_OFF_TRAN_1 = TRAN_1_FUNCTION( 0 , 0 , SFC_STEP_WWCRANK_11_TRAN_2 , SFC_STEP_NOT_ABORT_NOT );
...
SFC_STEP_T0_GT_20_A_EQUAL = A_EQUAL_FUNCTION( SFC_STEP_T0_A_NAME , 20_0 , 0 );
SFC_STEP_T0_GT_50_A_COMPARE = A_COMPARE_FUNCTION( SFC_STEP_T0_A_NAME , 50_0 , 0 );
SFC_STEP_T0_GT_50_A_EQUAL = A_EQUAL_FUNCTION( SFC_STEP_T0_A_NAME , 50_0 , 0 );
