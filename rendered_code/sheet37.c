...
COND_MON_T3BASETM_ELAP_TIME = ELAP_TIME_FUNCTION( COND_MON_T3BASE_AND , 0 , COND_MON_NV_RESET_B_NAME , 1_0 , "HR" );
COND_MON_T3BASETM_OUT_1 = OUT_1_FUNCTION( COND_MON_T3BASE_AND , 0 , COND_MON_NV_RESET_B_NAME , 1_0 , "HR" );
COND_MON_T3GT1003_A_COMPARE = A_COMPARE_FUNCTION( CORE_ANALOG_T3SEL , 1003_0 , 0 );
COND_MON_T3GT1003_A_EQUAL = A_EQUAL_FUNCTION( CORE_ANALOG_T3SEL , 1003_0 , 0 );
COND_MON_T3GT998_A_COMPARE = A_COMPARE_FUNCTION( CORE_ANALOG_T3SEL , 998_0 , 0 );
COND_MON_T3GT998_A_EQUAL = A_EQUAL_FUNCTION( CORE_ANALOG_T3SEL , 998_0 , 0 );
COND_MON_T3LT1003_A_COMPARE = A_COMPARE_FUNCTION( 1002_9 , CORE_ANALOG_T3SEL , 0 );
COND_MON_T3LT1003_A_EQUAL = A_EQUAL_FUNCTION( 1002_9 , CORE_ANALOG_T3SEL , 0 );
COND_MON_T3PEAK_AND = AND_FUNCTION( COND_MON_T3GT1003_A_COMPARE , CORE_DIGITAL_FUELON , IFACE_CORE_Z_SWPEAK_B_NAME );
COND_MON_T3PEAKTM_OUT_1 = OUT_1_FUNCTION( COND_MON_T3PEAK_AND , 0 , COND_MON_NV_RESET_B_NAME , 1_0 , "HR" );
COND_MON_T3PEAKTM_ELAP_TIME = ELAP_TIME_FUNCTION( COND_MON_T3PEAK_AND , 0 , COND_MON_NV_RESET_B_NAME , 1_0 , "HR" );
COND_MON_T48BASE_AND = AND_FUNCTION( COND_MON_T48GT1575_A_COMPARE , COND_MON_T48LT1584_A_COMPARE , CORE_DIGITAL_FUELON );
COND_MON_T48BASETM_ELAP_TIME = ELAP_TIME_FUNCTION( COND_MON_T48BASE_AND , 0 , COND_MON_NV_RESET_B_NAME , 1_0 , "HR" );
COND_MON_T48BASETM_OUT_1 = OUT_1_FUNCTION( COND_MON_T48BASE_AND , 0 , COND_MON_NV_RESET_B_NAME , 1_0 , "HR" );
COND_MON_T48GT1575_A_COMPARE = A_COMPARE_FUNCTION( CORE_ANALOG_T48SEL , 1575_0 , 0 );
COND_MON_T48GT1575_A_EQUAL = A_EQUAL_FUNCTION( CORE_ANALOG_T48SEL , 1575_0 , 0 );
COND_MON_T48GT1585_A_COMPARE = A_COMPARE_FUNCTION( CORE_ANALOG_T48SEL , 1585_0 , 0 );
COND_MON_T48GT1585_A_EQUAL = A_EQUAL_FUNCTION( CORE_ANALOG_T48SEL , 1585_0 , 0 );
COND_MON_T48LT1584_A_COMPARE = A_COMPARE_FUNCTION( 1584_9 , CORE_ANALOG_T48SEL , 0 );
COND_MON_T48LT1584_A_EQUAL = A_EQUAL_FUNCTION( 1584_9 , CORE_ANALOG_T48SEL , 0 );
COND_MON_T48PEAK_AND = AND_FUNCTION( COND_MON_T48GT1585_A_COMPARE , CORE_DIGITAL_FUELON , IFACE_CORE_Z_SWPEAK_B_NAME );
COND_MON_T48PEAKTM_ELAP_TIME = ELAP_TIME_FUNCTION( COND_MON_T48PEAK_AND , 0 , COND_MON_NV_RESET_B_NAME , 1_0 , "HR" );
COND_MON_T48PEAKTM_OUT_1 = OUT_1_FUNCTION( COND_MON_T48PEAK_AND , 0 , COND_MON_NV_RESET_B_NAME , 1_0 , "HR" );
