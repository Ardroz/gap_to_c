...
COND_MON_PRIORTM01_OUT_1 = I_TO_AN_FUNCTION( 0 , *0 (0, 99999999) );
COND_MON_PRIORTM02_OUT_1 = I_TO_AN_FUNCTION( 0 , *0 (0, 99999999) );
COND_MON_PRIORTM03_OUT_1 = I_TO_AN_FUNCTION( 0 , *0 (0, 99999999) );
COND_MON_PRIORTM04_OUT_1 = I_TO_AN_FUNCTION( 0 , *0 (0, 99999999) );
...
ACCUM_FUNCTION(COND_MON_T3BASE_AND , 0 , COND_MON_NV_RESET_B_NAME , 1_0 , "HR");
COND_MON_T3BASETM_ELAP_TIME = output1;
COND_MON_T3BASETM_OUT_1 = output2;
A_COMPARE_FUNCTION(CORE_ANALOG_T3SEL , 1003_0 , 0);
COND_MON_T3GT1003_A_COMPARE = output1;
COND_MON_T3GT1003_A_EQUAL = output2;
A_COMPARE_FUNCTION(CORE_ANALOG_T3SEL , 998_0 , 0);
COND_MON_T3GT998_A_COMPARE = output1;
COND_MON_T3GT998_A_EQUAL = output2;
A_COMPARE_FUNCTION(1002_9 , CORE_ANALOG_T3SEL , 0);
...
ACCUM_FUNCTION(COND_MON_T3PEAK_AND , 0 , COND_MON_NV_RESET_B_NAME , 1_0 , "HR");
...
ACCUM_FUNCTION(COND_MON_T48PEAK_AND , 0 , COND_MON_NV_RESET_B_NAME , 1_0 , "HR");
