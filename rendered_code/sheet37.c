...
COND_MON_T3BASETM_ACCUM = ACCUM_FUNCTION( "ELAP_TIME" , COND_MON_T3BASE_AND , 0 , COND_MON_NV_RESET_B_NAME , 1_0 , "HR" );
COND_MON_T3BASETM_ACCUM = ACCUM_FUNCTION( "OUT_1" , COND_MON_T3BASE_AND , 0 , COND_MON_NV_RESET_B_NAME , 1_0 , "HR" );
COND_MON_T3GT1003_A_COMPARE = A_COMPARE_FUNCTION( "A_COMPARE" , CORE_ANALOG_T3SEL , 1003_0 , 0 );
COND_MON_T3GT1003_A_COMPARE = A_COMPARE_FUNCTION( "A_EQUAL" , CORE_ANALOG_T3SEL , 1003_0 , 0 );
COND_MON_T3GT998_A_COMPARE = A_COMPARE_FUNCTION( "A_COMPARE" , CORE_ANALOG_T3SEL , 998_0 , 0 );
COND_MON_T3GT998_A_COMPARE = A_COMPARE_FUNCTION( "A_EQUAL" , CORE_ANALOG_T3SEL , 998_0 , 0 );
COND_MON_T3LT1003_A_COMPARE = A_COMPARE_FUNCTION( "A_COMPARE" , 1002_9 , CORE_ANALOG_T3SEL , 0 );
COND_MON_T3LT1003_A_COMPARE = A_COMPARE_FUNCTION( "A_EQUAL" , 1002_9 , CORE_ANALOG_T3SEL , 0 );
