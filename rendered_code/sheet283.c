...
SPRINT_TMR_CNVT_I_TO_AN = I_TO_AN_FUNCTION( 0 , SPRINT_FILL_DLY_R_TIME , SPRINT_DLY_HPHLD_R_TIME , SPRINT_DRAINHP_TM_R_TIME , SPRINT_DLY_LPEHLD_R_TIME , SPRINT_EVAC_TMR_R_TIME , SPRINT_LP_PRG_TMR_R_TIME , SPRINT_DN_PRG_TMR_R_TIME , SPRINT_HP_PRG_TMR_R_TIME , SPRINT_DLY_LPPHLD_R_TIME );
