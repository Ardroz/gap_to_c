...
SFC_TIMER_STI_1_TIME_T_TO_HMS = T_TO_HMS_FUNCTION( 0 , SFC_TIMER_STI_1_T_A_TO_T );
...
SFC_TIMER_STI_2_TIME_T_TO_HMS = T_TO_HMS_FUNCTION( 0 , SFC_TIMER_STI_2_T_A_TO_T );
SFC_TIMER_STI_2_Z_ZMINUS1_B = ZMINUS1_B_FUNCTION( SFC_TIMER_STI2TMASK_AND );
SFC_TIMER_STI_ACT_CM_I_COMPARE = I_COMPARE_FUNCTION( SFC_TIMER_STI_2_DLY_R_TIME , 0 );
...
SFC_TIMER_WARMONCMP_I_COMPARE = I_COMPARE_FUNCTION( SFC_TIMER_WARMUPDLY_R_TIME , 0 );
...
SFC_TIMER_WARMUPTIME_T_TO_HMS = T_TO_HMS_FUNCTION( 0 , SFC_TIMER_WARMUP_T_A_TO_T );
