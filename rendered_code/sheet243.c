...
FIN_FAN_X68327AOS_ONE_SHOT = ONE_SHOT_FUNCTION( 0 , FIN_FAN_A_OR , 0_16 , 0 );
FIN_FAN_X68327AOS_R_TIME = R_TIME_FUNCTION( 0 , FIN_FAN_A_OR , 0_16 , 0 );
FIN_FAN_X68327A_Z_ZMINUS1_B = ZMINUS1_B_FUNCTION( FIN_FAN_LAT68327A_LATCH );
FIN_FAN_X68327BOS_ONE_SHOT = ONE_SHOT_FUNCTION( 0 , FIN_FAN_B_OR , 0_16 , 0 );
FIN_FAN_X68327BOS_R_TIME = R_TIME_FUNCTION( 0 , FIN_FAN_B_OR , 0_16 , 0 );
FIN_FAN_X68327B_Z_ZMINUS1_B = ZMINUS1_B_FUNCTION( FIN_FAN_LAT68327B_LATCH );
FIN_FAN_X68327COS_ONE_SHOT = ONE_SHOT_FUNCTION( 0 , FIN_FAN_C_OR , 0_16 , 0 );
FIN_FAN_X68327COS_R_TIME = R_TIME_FUNCTION( 0 , FIN_FAN_C_OR , 0_16 , 0 );
