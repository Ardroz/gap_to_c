...
VSV_CAL_EQ_0_I_COMPARE = I_COMPARE_FUNCTION( VSV_CAL_CAL_STATUS_I_NAME , 0 );
VSV_CAL_EQ_1_I_COMPARE = I_COMPARE_FUNCTION( VSV_CAL_CAL_STATUS_I_NAME , 1 );
VSV_CAL_EQ_2_I_COMPARE = I_COMPARE_FUNCTION( VSV_CAL_CAL_STATUS_I_NAME , 2 );
VSV_CAL_EQ_3_I_COMPARE = I_COMPARE_FUNCTION( VSV_CAL_CAL_STATUS_I_NAME , 3 );
