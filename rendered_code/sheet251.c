...
ONE_SHOT_FUNCTION(1 , 1.0 ,  , XNSD_REF_BRKR_OPEN_NOT,&XNSD_REF_BRK_STPIDL_ONE_SHOT,&XNSD_REF_BRK_STPIDL_R_TIME,&XNSD_REF_BRK_STPIDL_LAST_TRIGGER);
...
T_FLIPFLOP_FUNCTION(1 , XNSD_REF_FASTAND_Z_ZMINUS1_B ,  , XNSD_REF_RST_FAST_OR,&XNSD_REF_FAST_LOAD_T_FLIPFLOP,&XNSD_REF_FAST_LOAD_IN_1_LAST, &XNSD_REF_FAST_LOAD_IN_2_LAST); 
...
ONE_SHOT_FUNCTION(1 , 0.5 ,  , XNSD_REF_REF_RESET_OR,&XNSD_REF_FUELOFFOS_ONE_SHOT,&XNSD_REF_FUELOFFOS_R_TIME,&XNSD_REF_FUELOFFOS_LAST_TRIGGER);
...
ONE_SHOT_FUNCTION(1 , 1.0 ,  , CORE_DIGITAL_STEPIDLE,&XNSD_REF_NPTSTEPEN_ONE_SHOT,&XNSD_REF_NPTSTEPEN_R_TIME,&XNSD_REF_NPTSTEPEN_LAST_TRIGGER);
...
ONE_SHOT_FUNCTION(1 , 0.1 ,  , GENERATOR_ISOCH_B_NAME,&XNSD_REF_N_I_RST_OS_ONE_SHOT,&XNSD_REF_N_I_RST_OS_R_TIME,&XNSD_REF_N_I_RST_OS_LAST_TRIGGER);
