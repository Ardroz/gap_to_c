...
VENT_G_DLY_A_DELAY = DELAY_FUNCTION( "DELAY" , 0 , VENT_MOT6413SFC_SFC_STEP , 0 , *2_0 (0_0, 5_0) );
VENT_G_DLY_A_DELAY = DELAY_FUNCTION( "R_TIME" , 0 , VENT_MOT6413SFC_SFC_STEP , 0 , *2_0 (0_0, 5_0) );
VENT_G_DLY_B_DELAY = DELAY_FUNCTION( "DELAY" , 0 , VENT_MOT6416SFC_SFC_STEP , 0 , *2_0 (0_0, 5_0) );
VENT_G_DLY_B_DELAY = DELAY_FUNCTION( "R_TIME" , 0 , VENT_MOT6416SFC_SFC_STEP , 0 , *2_0 (0_0, 5_0) );
...
VENT_TE6401_HI_A_COMPARE = A_COMPARE_FUNCTION( "A_COMPARE" , VENT_TE6401_A_NAME , 200_0 , *-30_0 (-60_0, 10_0) );
VENT_TE6401_HI_A_COMPARE = A_COMPARE_FUNCTION( "A_EQUAL" , VENT_TE6401_A_NAME , 200_0 , *-30_0 (-60_0, 10_0) );
VENT_TE6402_HI_A_COMPARE = A_COMPARE_FUNCTION( "A_COMPARE" , VENT_TE6402_A_NAME , *125_0 (125_0, 150_0) , *-10_0 (-30_0, 10_0) );
VENT_TE6402_HI_A_COMPARE = A_COMPARE_FUNCTION( "A_EQUAL" , VENT_TE6402_A_NAME , *125_0 (125_0, 150_0) , *-10_0 (-30_0, 10_0) );
VENT_TE6430_HI_A_COMPARE = A_COMPARE_FUNCTION( "A_COMPARE" , VENT_TE6430_A_NAME , 200_0 , *-15_0 (-30_0, 10_0) );
VENT_TE6430_HI_A_COMPARE = A_COMPARE_FUNCTION( "A_EQUAL" , VENT_TE6430_A_NAME , 200_0 , *-15_0 (-30_0, 10_0) );
VENT_TE6454_HI_A_COMPARE = A_COMPARE_FUNCTION( "A_COMPARE" , VENT_TE6454_A_NAME , 140_0 , *-20_0 (-60_0, 10_0) );
VENT_TE6454_HI_A_COMPARE = A_COMPARE_FUNCTION( "A_EQUAL" , VENT_TE6454_A_NAME , 140_0 , *-20_0 (-60_0, 10_0) );
...
VENT_T_DLY_A_DELAY = DELAY_FUNCTION( "DELAY" , 0 , VENT_MOT6417SFC_SFC_STEP , 0 , *2_0 (0_0, 5_0) );
VENT_T_DLY_A_DELAY = DELAY_FUNCTION( "R_TIME" , 0 , VENT_MOT6417SFC_SFC_STEP , 0 , *2_0 (0_0, 5_0) );
VENT_T_DLY_B_DELAY = DELAY_FUNCTION( "DELAY" , 0 , VENT_MOT6418SFC_SFC_STEP , 0 , *2_0 (0_0, 5_0) );
VENT_T_DLY_B_DELAY = DELAY_FUNCTION( "R_TIME" , 0 , VENT_MOT6418SFC_SFC_STEP , 0 , *2_0 (0_0, 5_0) );
