...
SPRINT_PMPDLYON_DELAY = DELAY_FUNCTION( "DELAY" , 0 , SPRINT_MOT62226_B_NAME , 0 , *5_0 (0_0, 30_0) );
SPRINT_PMPDLYON_DELAY = DELAY_FUNCTION( "R_TIME" , 0 , SPRINT_MOT62226_B_NAME , 0 , *5_0 (0_0, 30_0) );
...
SPRINT_TE62243LOG_CALC_PLUS = CALC_PLUS_FUNCTION( "ALM" , 0 , 0 , aout1 , iout1 , sd , SPRINT_TE62243_A_NAME , input , SPRINT_TE62243SPT_A_SW , sp , 1 , iin_1 , SPRINT_SOV62252_B_NAME , e1 , SPRINT_SOV62253_B_NAME , e2 , if ((input > sp) && (e1 || e2)) , { sd = true; } , else , { sd = false; } );
SPRINT_TE62243LOG_CALC_PLUS = CALC_PLUS_FUNCTION( "A_OUT_1" , 0 , 0 , aout1 , iout1 , sd , SPRINT_TE62243_A_NAME , input , SPRINT_TE62243SPT_A_SW , sp , 1 , iin_1 , SPRINT_SOV62252_B_NAME , e1 , SPRINT_SOV62253_B_NAME , e2 , if ((input > sp) && (e1 || e2)) , { sd = true; } , else , { sd = false; } );
SPRINT_TE62243LOG_CALC_PLUS = CALC_PLUS_FUNCTION( "I_OUT_1" , 0 , 0 , aout1 , iout1 , sd , SPRINT_TE62243_A_NAME , input , SPRINT_TE62243SPT_A_SW , sp , 1 , iin_1 , SPRINT_SOV62252_B_NAME , e1 , SPRINT_SOV62253_B_NAME , e2 , if ((input > sp) && (e1 || e2)) , { sd = true; } , else , { sd = false; } );
SPRINT_TE62243LOG_CALC_PLUS = CALC_PLUS_FUNCTION( "B_OUT_1" , 0 , 0 , aout1 , iout1 , sd , SPRINT_TE62243_A_NAME , input , SPRINT_TE62243SPT_A_SW , sp , 1 , iin_1 , SPRINT_SOV62252_B_NAME , e1 , SPRINT_SOV62253_B_NAME , e2 , if ((input > sp) && (e1 || e2)) , { sd = true; } , else , { sd = false; } );
