...
WTR_WASH_FAILDLY2_DELAY = DELAY_FUNCTION( "DELAY" , 0 , WTR_WASH_WW_TIMEACT_B_NAME , 0 , *1800_0 (300_0, 3600_0) );
WTR_WASH_FAILDLY2_DELAY = DELAY_FUNCTION( "R_TIME" , 0 , WTR_WASH_WW_TIMEACT_B_NAME , 0 , *1800_0 (300_0, 3600_0) );
...
WTR_WASH_MTR_PRMDLY_DELAY = DELAY_FUNCTION( "DELAY" , 0 , WTR_WASH_NOTSOV6540_NOT , WTR_WASH_PRGDLY_ADD_ADD , 0 );
WTR_WASH_MTR_PRMDLY_DELAY = DELAY_FUNCTION( "R_TIME" , 0 , WTR_WASH_NOTSOV6540_NOT , WTR_WASH_PRGDLY_ADD_ADD , 0 );
...
WTR_WASH_PRGTOHMS_T_TO_HMS = T_TO_HMS_FUNCTION( "YEAR" , 0 , WTR_WASH_PRGCNVT_A_TO_T );
WTR_WASH_PRGTOHMS_T_TO_HMS = T_TO_HMS_FUNCTION( "MONTH" , 0 , WTR_WASH_PRGCNVT_A_TO_T );
WTR_WASH_PRGTOHMS_T_TO_HMS = T_TO_HMS_FUNCTION( "DAY" , 0 , WTR_WASH_PRGCNVT_A_TO_T );
WTR_WASH_PRGTOHMS_T_TO_HMS = T_TO_HMS_FUNCTION( "HOUR" , 0 , WTR_WASH_PRGCNVT_A_TO_T );
WTR_WASH_PRGTOHMS_T_TO_HMS = T_TO_HMS_FUNCTION( "MIN" , 0 , WTR_WASH_PRGCNVT_A_TO_T );
WTR_WASH_PRGTOHMS_T_TO_HMS = T_TO_HMS_FUNCTION( "SEC" , 0 , WTR_WASH_PRGCNVT_A_TO_T );
WTR_WASH_PRGTOHMS_T_TO_HMS = T_TO_HMS_FUNCTION( "MICROSEC" , 0 , WTR_WASH_PRGCNVT_A_TO_T );
WTR_WASH_PRG_NEGDLY_DELAY = DELAY_FUNCTION( "DELAY" , 0 , WTR_WASH_SOV6540_OR_OR , 0 , WTR_WASH_PRGDLYTM_A_NAME );
WTR_WASH_PRG_NEGDLY_DELAY = DELAY_FUNCTION( "R_TIME" , 0 , WTR_WASH_SOV6540_OR_OR , 0 , WTR_WASH_PRGDLYTM_A_NAME );
...
WTR_WASH_PURGE_OS_ONE_SHOT = ONE_SHOT_FUNCTION( "ONE_SHOT" , 0 , WTR_WASH_PURGE_OR_OR , WTR_WASH_PRG_TIMER_A_NAME , SFC_STEP_WWCRANK_1_SFC_STEP );
WTR_WASH_PURGE_OS_ONE_SHOT = ONE_SHOT_FUNCTION( "R_TIME" , 0 , WTR_WASH_PURGE_OR_OR , WTR_WASH_PRG_TIMER_A_NAME , SFC_STEP_WWCRANK_1_SFC_STEP );
...
WTR_WASH_WW_PRGTMR_DELAY = DELAY_FUNCTION( "DELAY" , 0 , WTR_WASH_PURGE_OS_ONE_SHOT , WTR_WASH_PRG_TIMER_A_NAME , 0 );
WTR_WASH_WW_PRGTMR_DELAY = DELAY_FUNCTION( "R_TIME" , 0 , WTR_WASH_PURGE_OS_ONE_SHOT , WTR_WASH_PRG_TIMER_A_NAME , 0 );
WTR_WASH_WW_SKTIMER_DELAY = DELAY_FUNCTION( "DELAY" , 0 , WTR_WASH_STRT_SKTMR_B_NAME , 0 , *600_0 (0_0, 6000_0) );
WTR_WASH_WW_SKTIMER_DELAY = DELAY_FUNCTION( "R_TIME" , 0 , WTR_WASH_STRT_SKTMR_B_NAME , 0 , *600_0 (0_0, 6000_0) );
...
WTR_WASH_WW_TIMER_DELAY = DELAY_FUNCTION( "DELAY" , 0 , SFC_STEP_WW_TMRMSK_AND , WTR_WASH_WW_TIME_A_NAME , 0 );
WTR_WASH_WW_TIMER_DELAY = DELAY_FUNCTION( "R_TIME" , 0 , SFC_STEP_WW_TMRMSK_AND , WTR_WASH_WW_TIME_A_NAME , 0 );
