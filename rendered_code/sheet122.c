...
HMI_INTER_PT62140A_CALC_PLUS = CALC_PLUS_FUNCTION( { out = ( english*6_894757293 ); } , else , { out = english; } , 0 , 0 , out , DUMMY_IO , DUMMY_BO , GP1_CALC_GP1PA_A_NAME , english , 1 , DUMMY_I , HMI_INTER_ENG_SI_B_NAME , SI , if ( SI ) );
HMI_INTER_PT62140B_CALC_PLUS = CALC_PLUS_FUNCTION( 0 , 0 , out , DUMMY_IO , DUMMY_BO , GP1_CALC_GP1PB_A_NAME , english , 1 , DUMMY_I , HMI_INTER_ENG_SI_B_NAME , SI , if ( SI ) , { out = ( english*6_894757293 ); } , else , { out = english; } );
