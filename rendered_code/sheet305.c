...
LEAF_LOAD_ATIDLEOFF_R_TIME = R_TIME_FUNCTION( 0 , LEAF_LOAD_IDLELATCH_LATCH , 1_0 , 0 );
LEAF_LOAD_AT_IDLE_B_NAME = B_NAME_FUNCTION( CORE_DIGITAL_C_N25ATIDL );
LEAF_LOAD_A_TO_I_OUT_1 = OUT_1_FUNCTION( 0 , LEAF_LOAD_BRNDMDR_A_NAME , LEAF_LOAD_BRNDMD_A_NAME );
LEAF_LOAD_A_TO_I_OUT_2 = OUT_2_FUNCTION( 0 , LEAF_LOAD_BRNDMDR_A_NAME , LEAF_LOAD_BRNDMD_A_NAME );
...
LEAF_LOAD_CLROS_R_TIME = R_TIME_FUNCTION( 0 , LEAF_LOAD_MAN_RST_B_NAME , 1_0 , 0 );
...
LEAF_LOAD_INTEGRATE_INT_Z = INT_Z_FUNCTION( 0 , LEAF_LOAD_INT_SW_A_SW , -32767_0 , 32767_0 , -32767_0 , 32767_0 , 0_0 , LEAF_LOAD_RESET_OR_OR , 0_0 );
...
LEAF_LOAD_LITEOFFOS_R_TIME = R_TIME_FUNCTION( 0 , LEAF_LOAD_LITEOFF_B_NAME , 1_0 , 0 );
...
LEAF_LOAD_MANONOS_R_TIME = R_TIME_FUNCTION( LEAF_LOAD_MANUALON_B_NAME , 1_0 , 0 , 0 );
LEAF_LOAD_MANOSOFF_ONE_SHOT = ONE_SHOT_FUNCTION( 0 , LEAF_LOAD_MANUALOFF_B_NAME , 1_0 , 0 );
LEAF_LOAD_MANOSOFF_R_TIME = R_TIME_FUNCTION( 0 , LEAF_LOAD_MANUALOFF_B_NAME , 1_0 , 0 );
...
LEAF_LOAD_REQEQ_DLY_R_TIME = R_TIME_FUNCTION( 0 , LEAF_LOAD_REQ_VS_DMD_EQ , 0 , *5_0 (0_0, 10_0) );
LEAF_LOAD_REQEQ_OS_ONE_SHOT = ONE_SHOT_FUNCTION( 0 , LEAF_LOAD_REQEQ_DLY_DELAY , 0_5 , 0 );
LEAF_LOAD_REQEQ_OS_R_TIME = R_TIME_FUNCTION( 0 , LEAF_LOAD_REQEQ_DLY_DELAY , 0_5 , 0 );
...
LEAF_LOAD_REQ_OS_R_TIME = R_TIME_FUNCTION( 0 , LEAF_LOAD_REQ_OR_OR , 0_16 , 0 );
LEAF_LOAD_REQ_VS_DMD_EQ = EQ_FUNCTION( LEAF_LOAD_A_TO_I_OUT_1 , LEAF_LOAD_A_TO_I_OUT_2 );
LEAF_LOAD_REQ_VS_DMD_LT = LT_FUNCTION( LEAF_LOAD_A_TO_I_OUT_1 , LEAF_LOAD_A_TO_I_OUT_2 );
LEAF_LOAD_REQ_VS_DMD_GT = GT_FUNCTION( LEAF_LOAD_A_TO_I_OUT_1 , LEAF_LOAD_A_TO_I_OUT_2 );
...
LEAF_LOAD_RUN_INT_HORN = HORN_FUNCTION( 0 , LEAF_LOAD_OFFOR_OR , 0 , 0 , 0 , LEAF_LOAD_LITEOFFOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_MANONOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_REQ_OS_ONE_SHOT , 0 , 0 );
LEAF_LOAD_RUN_INT_FIRST_ALM = FIRST_ALM_FUNCTION( 0 , LEAF_LOAD_OFFOR_OR , 0 , 0 , 0 , LEAF_LOAD_LITEOFFOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_MANONOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_REQ_OS_ONE_SHOT , 0 , 0 );
LEAF_LOAD_RUN_INT_SEL_1 = SEL_1_FUNCTION( 0 , LEAF_LOAD_OFFOR_OR , 0 , 0 , 0 , LEAF_LOAD_LITEOFFOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_MANONOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_REQ_OS_ONE_SHOT , 0 , 0 );
LEAF_LOAD_RUN_INT_ALM_NO_1 = ALM_NO_1_FUNCTION( 0 , LEAF_LOAD_OFFOR_OR , 0 , 0 , 0 , LEAF_LOAD_LITEOFFOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_MANONOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_REQ_OS_ONE_SHOT , 0 , 0 );
LEAF_LOAD_RUN_INT_SEL_2 = SEL_2_FUNCTION( 0 , LEAF_LOAD_OFFOR_OR , 0 , 0 , 0 , LEAF_LOAD_LITEOFFOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_MANONOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_REQ_OS_ONE_SHOT , 0 , 0 );
LEAF_LOAD_RUN_INT_ALM_NO_2 = ALM_NO_2_FUNCTION( 0 , LEAF_LOAD_OFFOR_OR , 0 , 0 , 0 , LEAF_LOAD_LITEOFFOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_MANONOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_REQ_OS_ONE_SHOT , 0 , 0 );
LEAF_LOAD_RUN_INT_SEL_3 = SEL_3_FUNCTION( 0 , LEAF_LOAD_OFFOR_OR , 0 , 0 , 0 , LEAF_LOAD_LITEOFFOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_MANONOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_REQ_OS_ONE_SHOT , 0 , 0 );
LEAF_LOAD_RUN_INT_ALM_NO_3 = ALM_NO_3_FUNCTION( 0 , LEAF_LOAD_OFFOR_OR , 0 , 0 , 0 , LEAF_LOAD_LITEOFFOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_MANONOS_ONE_SHOT , 0 , 0 , LEAF_LOAD_REQ_OS_ONE_SHOT , 0 , 0 );
