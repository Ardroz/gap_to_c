...
VENT_G_LEL_LAT_LATCH1 = LATCH1_FUNCTION( "LATCH1" , 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_G_AL_NOT , 0 , 0 , VENT_NOT_G_SD_NOT , 0 , 0 );
VENT_G_LEL_LAT_LATCH1 = LATCH1_FUNCTION( "HORN" , 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_G_AL_NOT , 0 , 0 , VENT_NOT_G_SD_NOT , 0 , 0 );
VENT_G_LEL_LAT_LATCH1 = LATCH1_FUNCTION( "FIRST_ALM" , 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_G_AL_NOT , 0 , 0 , VENT_NOT_G_SD_NOT , 0 , 0 );
VENT_G_LEL_LAT_LATCH1 = LATCH1_FUNCTION( "SEL_1" , 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_G_AL_NOT , 0 , 0 , VENT_NOT_G_SD_NOT , 0 , 0 );
VENT_G_LEL_LAT_LATCH1 = LATCH1_FUNCTION( "ALM_NO_1" , 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_G_AL_NOT , 0 , 0 , VENT_NOT_G_SD_NOT , 0 , 0 );
VENT_G_LEL_LAT_LATCH1 = LATCH1_FUNCTION( "SEL_2" , 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_G_AL_NOT , 0 , 0 , VENT_NOT_G_SD_NOT , 0 , 0 );
VENT_G_LEL_LAT_LATCH1 = LATCH1_FUNCTION( "ALM_NO_2" , 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_G_AL_NOT , 0 , 0 , VENT_NOT_G_SD_NOT , 0 , 0 );
...
VENT_T_LEL_LAT_LATCH1 = LATCH1_FUNCTION( "LATCH1" , 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_T_AL_NOT , 0 , 0 , VENT_NOT_T_SD_NOT , 0 , 0 );
VENT_T_LEL_LAT_LATCH1 = LATCH1_FUNCTION( "HORN" , 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_T_AL_NOT , 0 , 0 , VENT_NOT_T_SD_NOT , 0 , 0 );
VENT_T_LEL_LAT_LATCH1 = LATCH1_FUNCTION( "FIRST_ALM" , 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_T_AL_NOT , 0 , 0 , VENT_NOT_T_SD_NOT , 0 , 0 );
VENT_T_LEL_LAT_LATCH1 = LATCH1_FUNCTION( "SEL_1" , 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_T_AL_NOT , 0 , 0 , VENT_NOT_T_SD_NOT , 0 , 0 );
VENT_T_LEL_LAT_LATCH1 = LATCH1_FUNCTION( "ALM_NO_1" , 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_T_AL_NOT , 0 , 0 , VENT_NOT_T_SD_NOT , 0 , 0 );
VENT_T_LEL_LAT_LATCH1 = LATCH1_FUNCTION( "SEL_2" , 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_T_AL_NOT , 0 , 0 , VENT_NOT_T_SD_NOT , 0 , 0 );
VENT_T_LEL_LAT_LATCH1 = LATCH1_FUNCTION( "ALM_NO_2" , 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_T_AL_NOT , 0 , 0 , VENT_NOT_T_SD_NOT , 0 , 0 );
