...
VENT_G_LEL_LAT_HORN = HORN_FUNCTION( 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_G_AL_NOT , 0 , 0 , VENT_NOT_G_SD_NOT , 0 , 0 );
VENT_G_LEL_LAT_FIRST_ALM = FIRST_ALM_FUNCTION( 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_G_AL_NOT , 0 , 0 , VENT_NOT_G_SD_NOT , 0 , 0 );
VENT_G_LEL_LAT_SEL_1 = SEL_1_FUNCTION( 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_G_AL_NOT , 0 , 0 , VENT_NOT_G_SD_NOT , 0 , 0 );
VENT_G_LEL_LAT_ALM_NO_1 = ALM_NO_1_FUNCTION( 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_G_AL_NOT , 0 , 0 , VENT_NOT_G_SD_NOT , 0 , 0 );
VENT_G_LEL_LAT_SEL_2 = SEL_2_FUNCTION( 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_G_AL_NOT , 0 , 0 , VENT_NOT_G_SD_NOT , 0 , 0 );
VENT_G_LEL_LAT_ALM_NO_2 = ALM_NO_2_FUNCTION( 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_G_AL_NOT , 0 , 0 , VENT_NOT_G_SD_NOT , 0 , 0 );
...
VENT_T_LEL_LAT_HORN = HORN_FUNCTION( 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_T_AL_NOT , 0 , 0 , VENT_NOT_T_SD_NOT , 0 , 0 );
VENT_T_LEL_LAT_FIRST_ALM = FIRST_ALM_FUNCTION( 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_T_AL_NOT , 0 , 0 , VENT_NOT_T_SD_NOT , 0 , 0 );
VENT_T_LEL_LAT_SEL_1 = SEL_1_FUNCTION( 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_T_AL_NOT , 0 , 0 , VENT_NOT_T_SD_NOT , 0 , 0 );
VENT_T_LEL_LAT_ALM_NO_1 = ALM_NO_1_FUNCTION( 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_T_AL_NOT , 0 , 0 , VENT_NOT_T_SD_NOT , 0 , 0 );
VENT_T_LEL_LAT_SEL_2 = SEL_2_FUNCTION( 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_T_AL_NOT , 0 , 0 , VENT_NOT_T_SD_NOT , 0 , 0 );
VENT_T_LEL_LAT_ALM_NO_2 = ALM_NO_2_FUNCTION( 0 , ALARM_RESET_B_NAME , VENT_LELLAT_INI_B_NAME , 0 , 0 , VENT_NOT_T_AL_NOT , 0 , 0 , VENT_NOT_T_SD_NOT , 0 , 0 );
