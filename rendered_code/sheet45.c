...
COND_MON_BREQ_10_I_COMPARE = I_COMPARE_FUNCTION( COND_MON_BREQ_IG_OUT_1 , 10 );
COND_MON_BREQ_15_I_COMPARE = I_COMPARE_FUNCTION( COND_MON_BREQ_IG_OUT_1 , 15 );
COND_MON_BREQ_7_I_COMPARE = I_COMPARE_FUNCTION( COND_MON_BREQ_IG_OUT_1 , 7 );
COND_MON_BREQ_IG_A_TO_INT = A_TO_INT_FUNCTION( 0 , CORE_ANALOG_BRNREQR );
COND_MON_BRNREQ_3_I_COMPARE = I_COMPARE_FUNCTION( COND_MON_BREQ_IG_OUT_1 , 3 );
COND_MON_BRNREQ_5_I_COMPARE = I_COMPARE_FUNCTION( COND_MON_BREQ_IG_OUT_1 , 5 );
...
COND_MON_REQCMPDMD_I_COMPARE = I_COMPARE_FUNCTION( COND_MON_BREQ_IG_OUT_1 , COND_MON_BDMD_I_OUT_1 );
