...
DELAY_FUNCTION(0 , SIMULATE_POSANALMP_A_COMPARE , 0 , *0.25 (0.0, 3.0));
SIMULATE_POSANALDLP_R_TIME = output1;
SIMULATE_POSANALDLP_DELAY = output2;
A_COMPARE_FUNCTION(SIMULATE_POSPERCALC_CALCULATE , 0 , *1.0 (0.2, 3.0));
SIMULATE_POSANALMP_A_COMPARE = output1;
SIMULATE_POSANALMP_A_EQUAL = output2;
DELAY_FUNCTION(0 , SIMULATE_POSANSDP_A_COMPARE , 0 , *0.5 (0.0, 5.0));
SIMULATE_POSANSDDLP_DELAY = output1;
SIMULATE_POSANSDDLP_R_TIME = output2;
A_COMPARE_FUNCTION(SIMULATE_POSPERCALC_CALCULATE , 0 , *2.0 (0.2, 4.0));
SIMULATE_POSANSDP_A_COMPARE = output1;
SIMULATE_POSANSDP_A_EQUAL = output2;
CALCULATE_FUNCTION(0 , 0 , A1_A06_AIO_FCV62108FB_AI_COMBO , fdbk , CORE_ANALOG_GMVPDMD , dmd , fabs(dmd-fdbk));
SIMULATE_POSPERCALC_CALCULATE = output1;
SIMULATE_POSPERCALC_ALM = output2;
