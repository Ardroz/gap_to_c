...
SIMULATE_POSANALDLP_DELAY = DELAY_FUNCTION( "R_TIME" , 0 , SIMULATE_POSANALMP_A_COMPARE , 0 , *0_25 (0_0, 3_0) );
SIMULATE_POSANALDLP_DELAY = DELAY_FUNCTION( "DELAY" , 0 , SIMULATE_POSANALMP_A_COMPARE , 0 , *0_25 (0_0, 3_0) );
SIMULATE_POSANALMP_A_COMPARE = A_COMPARE_FUNCTION( "A_COMPARE" , SIMULATE_POSPERCALC_CALCULATE , 0 , *1_0 (0_2, 3_0) );
SIMULATE_POSANALMP_A_COMPARE = A_COMPARE_FUNCTION( "A_EQUAL" , SIMULATE_POSPERCALC_CALCULATE , 0 , *1_0 (0_2, 3_0) );
SIMULATE_POSANSDDLP_DELAY = DELAY_FUNCTION( "DELAY" , 0 , SIMULATE_POSANSDP_A_COMPARE , 0 , *0_5 (0_0, 5_0) );
SIMULATE_POSANSDDLP_DELAY = DELAY_FUNCTION( "R_TIME" , 0 , SIMULATE_POSANSDP_A_COMPARE , 0 , *0_5 (0_0, 5_0) );
SIMULATE_POSANSDP_A_COMPARE = A_COMPARE_FUNCTION( "A_COMPARE" , SIMULATE_POSPERCALC_CALCULATE , 0 , *2_0 (0_2, 4_0) );
SIMULATE_POSANSDP_A_COMPARE = A_COMPARE_FUNCTION( "A_EQUAL" , SIMULATE_POSPERCALC_CALCULATE , 0 , *2_0 (0_2, 4_0) );
SIMULATE_POSPERCALC_CALCULATE = CALCULATE_FUNCTION( "CALCULATE" , 0 , 0 , A1_A06_AIO_FCV62108FB_AI_COMBO , fdbk , CORE_ANALOG_GMVPDMD , dmd , fabs(dmd-fdbk) );
SIMULATE_POSPERCALC_CALCULATE = CALCULATE_FUNCTION( "ALM" , 0 , 0 , A1_A06_AIO_FCV62108FB_AI_COMBO , fdbk , CORE_ANALOG_GMVPDMD , dmd , fabs(dmd-fdbk) );
