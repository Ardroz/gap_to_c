...
SPRINT_S62260_PRG_DELAY = DELAY_FUNCTION( 0 , SPRINT_OFF_3_SFC_STEP , 0 , SPRINT_DRN_DLYSW_A_SW );
SPRINT_S62260_PRG_R_TIME = R_TIME_FUNCTION( 0 , SPRINT_OFF_3_SFC_STEP , 0 , SPRINT_DRN_DLYSW_A_SW );
...
SPRINT_T2GT40_A_COMPARE = A_COMPARE_FUNCTION( SPRINT_T2SEL_A_NAME , 40_0 , 0 );
SPRINT_T2GT40_A_EQUAL = A_EQUAL_FUNCTION( SPRINT_T2SEL_A_NAME , 40_0 , 0 );
