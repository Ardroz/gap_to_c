...
GEN_SCALESW09_A_SW = A_SW_FUNCTION( *TRUE , GEN_SCALE_09_CALCULATE , GEN_VA_A_DIV_DIVIDE );
GEN_SCALESW10_A_SW = A_SW_FUNCTION( *TRUE , GEN_SCALE_10_CALCULATE , GEN_VA_B_DIV_DIVIDE );
GEN_SCALESW11_A_SW = A_SW_FUNCTION( *TRUE , GEN_SCALE_11_CALCULATE , GEN_VA_C_DIV_DIVIDE );
...
GEN_SW_04_A_SW = A_SW_FUNCTION( GEN_GEN_METER_B_NAME , 1 , GEN_SCALE_04_CALCULATE );
GEN_SW_05_A_SW = A_SW_FUNCTION( GEN_GEN_METER_B_NAME , 1 , GEN_SCALE_05_CALCULATE );
GEN_SW_06_A_SW = A_SW_FUNCTION( GEN_GEN_METER_B_NAME , 1 , GEN_SCALE_06_CALCULATE );
GEN_SW_07_A_SW = A_SW_FUNCTION( GEN_GEN_METER_B_NAME , 1 , GEN_SCALE_07_CALCULATE );
GEN_SW_08_A_SW = A_SW_FUNCTION( GEN_GEN_METER_B_NAME , 1 , GEN_SCALE_08_CALCULATE );
GEN_SW_09_A_SW = A_SW_FUNCTION( GEN_GEN_METER_B_NAME , 1 , GEN_SCALESW09_A_SW );
GEN_SW_10_A_SW = A_SW_FUNCTION( GEN_GEN_METER_B_NAME , 1 , GEN_SCALESW10_A_SW );
GEN_SW_11_A_SW = A_SW_FUNCTION( GEN_GEN_METER_B_NAME , 1 , GEN_SCALESW11_A_SW );
GEN_SW_12_A_SW = A_SW_FUNCTION( GEN_GEN_METER_B_NAME , 1 , GEN_SCALE_12_CALCULATE );
