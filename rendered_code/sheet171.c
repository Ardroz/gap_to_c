...
MAPPING_AW_1_CMP_I_COMPARE = I_COMPARE_FUNCTION( MAPPING_NEGSW_1_I_SW , MAPPING_AW_1_SW_I_SW );
...
MAPPING_AW_2_CMP_I_COMPARE = I_COMPARE_FUNCTION( MAPPING_NEGSW_2_I_SW , MAPPING_AW_2_SW_I_SW );
...
MAPPING_AW_3_CMP_I_COMPARE = I_COMPARE_FUNCTION( MAPPING_NEGSW_3_I_SW , MAPPING_AW_3_SW_I_SW );
...
MAPPING_AW_4_CMP_I_COMPARE = I_COMPARE_FUNCTION( MAPPING_NEGSW_4_I_SW , MAPPING_AW_4_SW_I_SW );
...
MAPPING_AW_5_CMP_I_COMPARE = I_COMPARE_FUNCTION( MAPPING_NEGSW_5_I_SW , MAPPING_AW_5_SW_I_SW );
...
MAPPING_SMALLNEGS_I_TO_AN = I_TO_AN_FUNCTION( MAPPING_AW_5_SW_I_SW , 0 , MAPPING_AW_1_SW_I_SW , MAPPING_AW_2_SW_I_SW , MAPPING_AW_3_SW_I_SW , MAPPING_AW_4_SW_I_SW );
