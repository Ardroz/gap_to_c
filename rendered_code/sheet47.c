...
COND_MON_BGACTCNT_COUNTER = COUNTER_FUNCTION( "COUNTER" , 0 , COND_MON_BGACTADJ_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_26_OUT_1 , 0_0 );
COND_MON_BGACTCNT_COUNTER = COUNTER_FUNCTION( "CMP_OUT" , 0 , COND_MON_BGACTADJ_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_26_OUT_1 , 0_0 );
COND_MON_BREQCMP0_I_COMPARE = I_COMPARE_FUNCTION( "EQ" , COND_MON_BREQ_IG_OUT_1 , 0 );
COND_MON_BREQCMP0_I_COMPARE = I_COMPARE_FUNCTION( "LT" , COND_MON_BREQ_IG_OUT_1 , 0 );
COND_MON_BREQCMP0_I_COMPARE = I_COMPARE_FUNCTION( "GT" , COND_MON_BREQ_IG_OUT_1 , 0 );
COND_MON_BREQCMP10_I_COMPARE = I_COMPARE_FUNCTION( "EQ" , COND_MON_BREQ_IG_OUT_1 , 10 );
COND_MON_BREQCMP10_I_COMPARE = I_COMPARE_FUNCTION( "LT" , COND_MON_BREQ_IG_OUT_1 , 10 );
COND_MON_BREQCMP10_I_COMPARE = I_COMPARE_FUNCTION( "GT" , COND_MON_BREQ_IG_OUT_1 , 10 );
COND_MON_BREQCMP15_I_COMPARE = I_COMPARE_FUNCTION( "EQ" , COND_MON_BREQ_IG_OUT_1 , 15 );
COND_MON_BREQCMP15_I_COMPARE = I_COMPARE_FUNCTION( "LT" , COND_MON_BREQ_IG_OUT_1 , 15 );
COND_MON_BREQCMP15_I_COMPARE = I_COMPARE_FUNCTION( "GT" , COND_MON_BREQ_IG_OUT_1 , 15 );
COND_MON_BREQCMP3_I_COMPARE = I_COMPARE_FUNCTION( "EQ" , COND_MON_BREQ_IG_OUT_1 , 3 );
COND_MON_BREQCMP3_I_COMPARE = I_COMPARE_FUNCTION( "LT" , COND_MON_BREQ_IG_OUT_1 , 3 );
COND_MON_BREQCMP3_I_COMPARE = I_COMPARE_FUNCTION( "GT" , COND_MON_BREQ_IG_OUT_1 , 3 );
COND_MON_BREQCMP5_I_COMPARE = I_COMPARE_FUNCTION( "EQ" , COND_MON_BREQ_IG_OUT_1 , 5 );
COND_MON_BREQCMP5_I_COMPARE = I_COMPARE_FUNCTION( "LT" , COND_MON_BREQ_IG_OUT_1 , 5 );
COND_MON_BREQCMP5_I_COMPARE = I_COMPARE_FUNCTION( "GT" , COND_MON_BREQ_IG_OUT_1 , 5 );
COND_MON_BREQCMP7_I_COMPARE = I_COMPARE_FUNCTION( "EQ" , COND_MON_BREQ_IG_OUT_1 , 7 );
COND_MON_BREQCMP7_I_COMPARE = I_COMPARE_FUNCTION( "LT" , COND_MON_BREQ_IG_OUT_1 , 7 );
COND_MON_BREQCMP7_I_COMPARE = I_COMPARE_FUNCTION( "GT" , COND_MON_BREQ_IG_OUT_1 , 7 );
...
COND_MON_G10ACTCNT_COUNTER = COUNTER_FUNCTION( "COUNTER" , 0 , COND_MON_G10ACTADJ_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_30_OUT_1 , 0_0 );
COND_MON_G10ACTCNT_COUNTER = COUNTER_FUNCTION( "CMP_OUT" , 0 , COND_MON_G10ACTADJ_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_30_OUT_1 , 0_0 );
COND_MON_G15ACTADJ_AND = AND_FUNCTION( CORE_DIGITAL_T_ACOUSTIC , COND_MON_BREQCMP15_EQ , COND_MON_ABALADJOR_OR );
COND_MON_G15ACTCNT_COUNTER = COUNTER_FUNCTION( "COUNTER" , 0 , COND_MON_G15ACTADJ_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_31_OUT_1 , 0_0 );
COND_MON_G15ACTCNT_COUNTER = COUNTER_FUNCTION( "CMP_OUT" , 0 , COND_MON_G15ACTADJ_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_31_OUT_1 , 0_0 );
COND_MON_G3ACTADJ_AND = AND_FUNCTION( CORE_DIGITAL_T_ACOUSTIC , COND_MON_BREQCMP3_EQ , COND_MON_ABALADJOR_OR );
COND_MON_G3ACTCNT_COUNTER = COUNTER_FUNCTION( "COUNTER" , 0 , COND_MON_G3ACTADJ_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_27_OUT_1 , 0_0 );
COND_MON_G3ACTCNT_COUNTER = COUNTER_FUNCTION( "CMP_OUT" , 0 , COND_MON_G3ACTADJ_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_27_OUT_1 , 0_0 );
COND_MON_G5ACTADJ_AND = AND_FUNCTION( CORE_DIGITAL_T_ACOUSTIC , COND_MON_BREQCMP5_EQ , COND_MON_ABALADJOR_OR );
COND_MON_G5ACTCNT_COUNTER = COUNTER_FUNCTION( "COUNTER" , 0 , COND_MON_G5ACTADJ_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_28_OUT_1 , 0_0 );
COND_MON_G5ACTCNT_COUNTER = COUNTER_FUNCTION( "CMP_OUT" , 0 , COND_MON_G5ACTADJ_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_28_OUT_1 , 0_0 );
COND_MON_G7ACTADJ_AND = AND_FUNCTION( CORE_DIGITAL_T_ACOUSTIC , COND_MON_BREQCMP7_EQ , COND_MON_ABALADJOR_OR );
COND_MON_G7ACTCNT_COUNTER = COUNTER_FUNCTION( "COUNTER" , 0 , COND_MON_G7ACTADJ_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_29_OUT_1 , 0_0 );
COND_MON_G7ACTCNT_COUNTER = COUNTER_FUNCTION( "CMP_OUT" , 0 , COND_MON_G7ACTADJ_AND , COND_MON_NV_RESET_B_NAME , COND_MON_RST_29_OUT_1 , 0_0 );
