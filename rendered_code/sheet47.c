...
COND_MON_BREQCMP0_I_COMPARE = I_COMPARE_FUNCTION( COND_MON_BREQ_IG_OUT_1 , 0 );
COND_MON_BREQCMP10_I_COMPARE = I_COMPARE_FUNCTION( COND_MON_BREQ_IG_OUT_1 , 10 );
COND_MON_BREQCMP15_I_COMPARE = I_COMPARE_FUNCTION( COND_MON_BREQ_IG_OUT_1 , 15 );
COND_MON_BREQCMP3_I_COMPARE = I_COMPARE_FUNCTION( COND_MON_BREQ_IG_OUT_1 , 3 );
COND_MON_BREQCMP5_I_COMPARE = I_COMPARE_FUNCTION( COND_MON_BREQ_IG_OUT_1 , 5 );
COND_MON_BREQCMP7_I_COMPARE = I_COMPARE_FUNCTION( COND_MON_BREQ_IG_OUT_1 , 7 );
